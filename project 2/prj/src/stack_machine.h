...
/*Implements the division binary operation through IOperation interface
 *
 */
...
/*Implements the sign change binary operation through IOperation interface
 *
 */
class SignChangeOp : public IOperation {
public:
    //IOperation interface overriding
...
/*Implements ternary operation ? through IOperation interface
 *
 */
class TernarOp : public IOperation {
    //IOperation interface overriding
