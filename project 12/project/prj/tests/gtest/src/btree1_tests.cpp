...
TEST_G(BTreeTest, Search1)
{
    ...
    Byte* res = bt.search(&els[5]);
    cout << (unsigned char)res << endl;
}

TEST_F(BTreeStudentTest, Search1)
{
...
TEST_F(BTreeStudentTest, Search2)
{
...
TEST_F(BTreeStudentTest, SearchAll1)
{
...
TEST_F(BTreeStudentTest, SearchAll2)
{
...
TEST_F(BTreeStudentTest, SearchAll3)
{
