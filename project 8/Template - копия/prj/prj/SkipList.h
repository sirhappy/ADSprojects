...
public:
    ...
    // Copy constructor
    // It makes copy only of the lowest level,
    // upper levels are builded using insert().
    ...
    // Copy operation
    // Creates copy only of the lowest element,
    // upper levels are builded using insert();
    SkipList& operator=(const SkipList& other);

protected:
    // Swaps first and second SkipLists (demanded by copy and swap idiom)    
    static void swap(SkipList& first, SkipList& second);
};
//=============================================================================
//== End of: SkipList =========================================================
//=============================================================================
