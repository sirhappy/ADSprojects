...
public:
    ...
    /// Деструктор
    ~Node();  //TODO:Правило трех!!!узнать нужно ли реализовывать
...
public:
    ...
    LinkedList& operator =(const LinkedList& rhvLinkedList);
...
private:
    /// Функция меняет 2 LinkedList местами
    void swapLinkedLists(LinkedList& left, LinkedList& right);
