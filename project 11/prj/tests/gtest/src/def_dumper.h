 ...
 */
template <typename Element, typename Compar = std::less<Element>> // = std::less<Element> >
...
public:
    virtual void rbTreeEvent(RBTreeDumperEvent ev, TTree* tr, TTreeNode* nd) override
    {
