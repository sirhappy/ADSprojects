...
void Encoder::setCode(const string code, const unsigned char pos)
{
    _codes[pos] = code;
}
...
//Method for encoding file using buffers of chars
...
//=============================================================================
//This method uses unsigned chars for encoding
/*void Encoder::encodeBytes()
{
    _fout << _fin.tellg() << 'S';  //store file size and separating symbol
    _fin.seekg(0, ios::beg);
